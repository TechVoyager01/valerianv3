...
# i added a defeat object so that when the foe is defeated you can display a message about this
class Enemy:
    def __init__(self, id, encounter, name, description, defeat, appearance, abilities, weakness, location, chapter, health, attack, defence, gold, potion, elixir):
        self.id = id
...
#     name="Street Thug",
#     description="Common criminals lurking in the alleys of Glador.",
#     defeat="The Street Thug falls to the ground, defeated.",
